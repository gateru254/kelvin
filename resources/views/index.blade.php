...
<head>
	...
	<link rel="icon" type="image/png" sizes="32x32" href="images/favicon.ico">
      ...
      <!--	Title
    ==================================================-->
	<title>kelvin- Personal Portfolio</title>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-md-12 col-lg-12 home-content text-left">
                    <div class="mainbanner_content">
                        <span class="pb_5 banner_title color_white"> I am Kelvin Kiarie</span>  
			...
			<div class="row">
				<div class="col-md-12 col-lg-12">
					<div class="section_title_1 text-center mx-auto pb_60 wow animated slideInUp">
	                    ...
	                    <span class="sub_title"> People  find me to be an upbeat,self motivated team player with excellent communication skills.</span>
	                </div>
				</div>
			</div>
			<div class="about_Me ">
			...
			<div class="row">
				<div class="col-md-12 col-lg-12">
					<div class="section_title_1 text-center mx-auto pb_60 wow animated slideInUp">
	                    ...
	                    <span class="sub_title">Problem solver, independent person with high attention to detail.</span>
	                </div>
				</div>
			</div>
			<div class="my_skill">
				<div class="row">
					...
					<div class="col-md-12 col-lg-6">
					<div class="skill-progress wow animated slideInRight color_blue">
		                    <div class="prgs-bar fact-counter"> <span>UI/UX Designing</span>
		                        <div class="progress count wow" data-wow-duration="90ms">
						...
						<div class="skill-progress wow animated slideInRight color_yellow">
		                    <div class="prgs-bar fact-counter"> <span>MOBILE PAYMENTS API'S</span>
		                        <div class="progress count wow" data-wow-duration="65ms">
								<div class="skill-percent"><span class="count-num" data-speed="3000" data-stop="75">75</span>%</div>
		                            <div class="progress-bar" role="progressbar" aria-valuenow="65" aria-valuemax="100"></div>
		                          
		                             </div>
		                    </div>
							<div class="skill-progress wow animated slideInRight color_yellow">
		                    <div class="prgs-bar fact-counter"> <span>DATA Analyst- 2 yrs of experience</span>
		                        <div class="progress count wow" data-wow-duration="50ms">
								<div class="skill-percent"><span class="count-num" data-speed="3000" data-stop="70">70</span>%</div>
		                            <div class="progress-bar" role="progressbar" aria-valuenow="50" aria-valuemax="100"></div>    
		                             </div>
							</div>
		                    <div class="prgs-bar fact-counter"> <span>Project Management - 2 yrs of experience</span>
		                        <div class="progress count wow" data-wow-duration="70ms">
		                            <div class="skill-percent"><span class="count-num" data-speed="3000" data-stop="75">75</span>%</div>
		                            <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemax="100"> </div>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-4 col-lg-4">
							    <div class="counter count wow text-center" data-wow-duration="300ms">
					            	...
					            	<div class="counting_digit color_default mt_15"> <h2 class="count-num" data-speed="3000" data-stop="22">0</h2><span>+</span>
					            	</div>
					            	<h3 class="color_white mt_15">project completed</h3>
					          	</div>
							</div>
							<div class="col-md-4 col-lg-4">
							    <div class="counter count wow text-center" data-wow-duration="300ms">
							    	<span class="flaticon-happy"></span>
					            	<div class="counting_digit color_default mt_15"><h2 class="count-num" data-speed="3000" data-stop="120">2</h2><span>+</span>
					            	</div>
	...
	<section id="services" class="py_80 full_row bg_white">
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-lg-12">
					<div class="section_title_1 text-center mx-auto pb_60 wow animated slideInUp">
	                    <h2 class="title text-uppercase"><span class="line_double mx-auto color_default">services</span>What i do best</h2>
						...
						<div class="row">
							<div class="col-md-6 col-lg-4">
								<div class="service_two text-center pt_15 mb_30 wow animated slideInUp">
					              ...
					              <h3 class="p_20 text-uppercase color_primary">Internet of things</h3>
					              <div class="srv_icon color_white"><span class="flaticon-website-design-symbol"></span></div>
					              <p>"we need to get smarter about hardwre and software innovation in order to get the most value  from the emerging internet of things".</p>
								</div>
							</div>
							<div class="col-md-6 col-lg-4">
								<div class="service_two text-center pt_15 mb_30 wow animated slideInUp">
					              ...
					              <p>Incudes analyzing user requirements then Designing,building $testing the desired software after undergoing all the development cycles and implementing it.</p>
								</div>
							</div>
							<div class="col-md-6 col-lg-4">
								<div class="service_two text-center pt_15 mb_30 wow animated slideInUp">
					              <div class="srv_item_number color_lightgray"><strong>03.</strong></div>
					              <h3 class="p_20 text-uppercase color_primary">Project Management</h3>
					              <div class="srv_icon color_white"><span class="flaticon-wordpress-logo"></span></div>
					              <p>Includes planning,budgeting,documenting and overseing all aspects of the specific project at hand.</p>
								</div>
							</div>
							<div class="col-md-6 col-lg-4">
								<div class="service_two text-center pt_15 mb_30 wow animated slideInUp">
					              <div class="srv_item_number color_lightgray"><strong>04.</strong></div>
					              <h3 class="p_20 text-uppercase color_primary">Artificial intelligence</h3>
					              <div class="srv_icon color_white"><span class="flaticon-editor"></span></div>
					              <p> "A changing environment will lead to the creation of new concepts in our head ".Visual perception,speech recognition & decision-making systems involve machine learning $ data mining.</p>
								</div>
							</div>
							<div class="col-md-6 col-lg-4">
								<div class="service_two text-center pt_15 mb_30 wow animated slideInUp">
					              <div class="srv_item_number color_lightgray"><strong>05.</strong></div>
					              <h3 class="p_20 text-uppercase color_primary">Branding & Marketing</h3>
					              <div class="srv_icon color_white"><span class="flaticon-internet"></span></div>
					              <p>Being the best at what you do often isn't enough.In many cases, Its also necessary to communicate the value that you create, Marketing and branding your IT department internally so that others within the organization are aware of the value your team create.</p>
								</div>
							</div>
							<div class="col-md-6 col-lg-4">
								<div class="service_two text-center pt_15 mb_30 wow animated slideInUp">
					              <div class="srv_item_number color_lightgray"><strong>06.</strong></div>
					              <h3 class="p_20 text-uppercase color_primary">Cross-Cultural leadership</h3>
					              <div class="srv_icon color_white"><span class="flaticon-shopping-cart"></span></div>
					              <p> A truly global citizen,I've learned to quickyly recognize cultural expectations adjust to differents environments quickly and work with other employess of other cultures.</p>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="col-md-12">
								<div class="filters mb_30 w-100 text-center">
									...
									<!--	<li class="active filter" data-role="button" data-filter="all">All</li>-->
										...
										<li class="filter" data-role="button" data-filter=".Umoja Expert Distributers">Umoja expert distributers </li>
										<li class="filter" data-role="button" data-filter=".University complaint System">University complaint System</li>
								...
								<div class="row">
								  	<div class="column mix mix_all graphic development wordpress mb_30 col-md-4 col-lg-4">
										<div class="default-portfolio-item">
											<a href="images/portfolio/covid.jpg" data-fancybox="gallery">
												<img src="images/portfolio/covid.jpg" alt="" />
			...
			<div class="row">
				<div class="col-md-12 col-lg-12">
					...
					<div class="section_title_1 text-center mx-auto pb_60 wow animated slideInUp">
	                    ...
	                    <span class="sub_title color_black">Please don't hesitate to contact me if you have any question,comments or messages.</span>
	                </div>
				</div>
				<div class="col-md-12 col-lg-12">
					<div class="row">
		    					...
		    					<ul>
		    						...
		    						<li>
		    							<div class="contact_text">
		    								...
		    								<span class="color_secondery">0791025786</span>
		    							</div>
		    						</li>
		    						<li>
		    							<div class="contact_text">
		    								<h6 class="font-weight-bold color_primary">Address</h6>
		    								<span class="color_secondery">348-00232, Ruiru.</span>
		    							</div>
		    						</li>
		    						<li>
		    							<div class="contact_text">
